...
class AdminController extends Controller {
  ...
  //::::::::::::::::::::::::::::::::::::::SERVICIOS TRAININNG
   public function adminServicioTenis() {
    ...
    return view('admin.servicioTenis')->with(compact('clases_'))->with(compact('rowData_'));
  }
   ...
   {        
         $file = $request->file('image');
           if($file){
               ...
               DB::table('servicio_training_descripcion')->insert([
           ...
           return back()->with('message','Se creo');
