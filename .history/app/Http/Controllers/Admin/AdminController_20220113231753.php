         ...
         $file = $request->file('image');
           ...
           switch($request->isValues) {
            ...
            case 'ACTUALIZAR': 
                  ...
                  if($file){
                    $url_imagen =  DB::table('servicio_training_descripcion')->where('id_servicio', '=', $request->txt_id_servicio)->get();
                    ...
                    if(file_exists(str_replace('/template_admin/', 'template_admin/',  $url_imagen[0]->url_image))){
                      ...
                      DB::table('servicio_training_descripcion')
                     ...
                     return json_encode(['data' => '/template_admin/img/'.$filename]);
