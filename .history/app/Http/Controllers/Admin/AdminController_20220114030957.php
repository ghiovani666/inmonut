...
class AdminController extends Controller {
  ...
  public function adminServicioHello() {
    ...
    $rowData_ = DB::table('servicio_training_titulo')->join('servicio_training_descripcion', 'servicio_training_titulo.id_titulo', '=', 'servicio_training_descripcion.id_titulo')->get()->toArray();
    return view('admin.servicioHello')->with(compact('rowData_'))->with(compact('rowData_cb'))->with(compact('rowData_cb_'));
  }
  ...
  {        
   ...
   public function listarDataTable() {
    ...
    ->get()->toArray();
    return view('admin.ajax.listTablaServicio')->with(compact('rowData_'));
   }
