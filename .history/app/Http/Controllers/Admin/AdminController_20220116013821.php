...
class AdminController extends Controller {
    ...
    public function slider() {
      $slider_ = DB::table('web_about')->where("id_home",">",1)->get();
  ...
  {        
          ...
          switch($request->txt_values) {
            case 'slider': 
                  ...
                  if($file){
                    $url_imagen =  DB::table('web_about')->where('id_home', '=', $request->txt_id_home)->get();
                    ...
                    DB::table('web_about')
                      ...
                      DB::table('web_about')
                        ...
                        $data=  DB::table('web_about')->where('id_home', '=', $request->txt_id_home)->get();
                        $html='';
                        $html.='
