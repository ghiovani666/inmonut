...
class AdminController extends Controller {
    ...
    public function slider() {
      $slider_ = DB::table('web_about')->where("id_about",">",1)->get();
      $slider_xx = DB::table('web_about')->get();
    ...
    public function fitness() {
      $clases_ = DB::table('web_fitness')->get();

      return view('admin.fitness')->with(compact('clases_'));
    }

    public function entrenador() {
      $clases_ = DB::table('web_entrenador')->get();
  ...
  // EXTRAER DATOS DASHBOARD HOME
    ...
    {        
      if($request->txt_isclass=="slider"){
        $result = DB::table('web_about')
        ->where("id_about",$request->txt_id_home)
        ->get();
  ...
  {        
          ...
          switch($request->txt_values) {
            case 'slider': 
                  ...
                  if($file){
                    $url_imagen =  DB::table('web_about')->where('id_about', '=', $request->txt_id_home)->get();
                    ...
                    DB::table('web_about')
                      ...
                      DB::table('web_about')
                        ...
                        $data=  DB::table('web_about')->where('id_about', '=', $request->txt_id_home)->get();
                        $html='';
                        $html.='
            ...
            case 'fitness': 
              ...
              if($file){
                $url_imagen =  DB::table('web_fitness')->where('id_about', '=', $request->txt_id_home)->get();
                ...
                DB::table('web_fitness')
                  ...
                  $data=  DB::table('web_fitness')->where('id_about', '=', $request->txt_id_home)->get();
                  $html='';
                  $html.='
                  <img class="card-img-top" src="'.$data[0]->url_image.'" alt="Photo">
                  <h6>'.$data[0]->title1.'</h6>
          ...
          case 'entrenador': 
            ...
            if($file){
              $url_imagen =  DB::table('web_entrenador')->where('id_about', '=', $request->txt_id_home)->get();
              ...
              DB::table('web_entrenador')
                ...
                $data=  DB::table('web_entrenador')->where('id_about', '=', $request->txt_id_home)->get();
                $html='';
                $html.='
                <img class="card-img-top" src="'.$data[0]->url_image.'" alt="Photo">
                <h6>'.$data[0]->title1.'</h6>
  ...
  {        
    ...
    public function adminServicioHello() {
      ...
      ->join('web_servicio_descripcion', 'servicio_training_titulo.id_titulo', '=', 'web_servicio_descripcion.id_titulo')
      ->join('web_servicio', 'servicio_training_titulo.id_servicio', '=', 'web_servicio.id_servicio')
      ->get()->toArray();
   ...
   {        
      ...
      public function editServicioTraining(Request $request) {
        // $rowData_ = DB::table('web_servicio_descripcion')
        // // ->join('web_servicio_descripcion', 'servicio_training_titulo.id_titulo', '=', 'web_servicio_descripcion.id_titulo')
