...
class AdminController extends Controller {
    ...
    public function slider() {
      $slider_ = DB::table('web_home')->where("id_home",">",1)->get();
  ...
  {        
          ...
          switch($request->txt_values) {
            ...
            case 'fitness': 
              ...
              if($file){
                $url_imagen =  DB::table('web_fitness')->where('id_home', '=', $request->txt_id_home)->get();
                ...
                DB::table('web_fitness')
                  ...
                  $data=  DB::table('web_fitness')->where('id_home', '=', $request->txt_id_home)->get();
                  $html='';
                  $html.='
                  <img class="card-img-top" src="'.$data[0]->url_image.'" alt="Photo">
                  <h6>'.$data[0]->title1.'</h6>
