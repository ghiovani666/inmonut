...
class GaleriaController extends Controller {
 ...
 {        
          ...
          case 'ACTUALIZAR': 
                ...
                if($file != NULL){
                  ...
                  case 'ELIMINAR': 
                    ...
                    DB::table('web_servicio_descripcion')->where('id_descripcion', '=', $request->txt_id_gallery)->delete();
    ...
    public function editServicioTraining(Request $request) {
      ...
      ->where("web_servicio_descripcion.id_descripcion", $request->txt_id_gallery)
      ->get()->toArray();
