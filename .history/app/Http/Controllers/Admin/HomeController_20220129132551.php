...
class HomeController extends Controller {
  ...
  public function localizacion () {
    $clases_ = DB::table('web_novedad')->where("id_servicio",8)->get();
  ...
  public function slider() {
    ...
    $slider_xx =DB::table('web_home')->where('tipo', '=', 1)->get();
  ...
  public function clases() {
    $clases_ = DB::table('web_home') ->where("tipo","=",3)->get();
  ...
  public function entrenador() {
    $clases_ = DB::table('web_home')->where("tipo","=",4)->get();
