...
class HomeController extends Controller
{
    ...
    public function viewServicioFisio(){
    	return view('web.layouts.pages.servicioFisio');
    }
    public function viewServicioFitness(){
    	return view('web.layouts.pages.servicioFitness');
    }
    public function viewServicioPadel(){
    	return view('web.layouts.pages.servicioPadel');
    }
    public function viewServicioTenis(){
    	return view('web.layouts.pages.servicioTenis');
    }
