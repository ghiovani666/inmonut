...
class HomeController extends Controller
{
    ...
    public function viewServicioTenis(){
        ...
        $rowData__ = DB::table('servicio_training_titulo')->join('servicio_training_descripcion', 'servicio_training_titulo.id_opcion', '=', 'servicio_training_descripcion.id_opcion')->where('servicio_training_descripcion.id_servicio', '=', 1)->get();
    	return view('web.layouts.pages.servicioTenis')->with(compact('rowData_'))->with(compact('rowData__'));
    }
