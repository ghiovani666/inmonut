...
class HomeController extends Controller
{
    ...
    public function viewServicioTenis(){
        ...
        $rowData__ = DB::table('servicio_training_titulo')->join('servicio_training_descripcion', 'servicio_training_titulo.id_titulo', '=', 'servicio_training_descripcion.id_titulo')->where('servicio_training_descripcion.id_servicio', '=', 1)->get();
