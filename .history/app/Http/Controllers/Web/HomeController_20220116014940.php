...
class HomeController extends Controller
{
    ...
    public function viewHome(){
        $slider_ = DB::table('web_about')->get();
        $clases_ = DB::table('web_about')->where('id_about', '>', 6)->get();
        $fitness_ = DB::table('web_fitness')->get();
        $entrenador_ = DB::table('web_entrenador')->get();
    ...
    public function viewServicioTenis(){
        ...
        $rowData_opciones = DB::table('servicio_training_titulo')->join('servicio_training_descripcion', 'servicio_training_titulo.id_titulo', '=', 'servicio_training_descripcion.id_titulo')->join('servicio_training', 'servicio_training_titulo.id_servicio', '=', 'servicio_training.id_servicio')->where('servicio_training.id_servicio', '=', 1)->get()->toArray();
    ...
    public function viewServicioPadel(){
        $rowData_ = DB::table('servicio_training')->get();
        $rowData_opciones = DB::table('servicio_training_titulo')->join('servicio_training_descripcion', 'servicio_training_titulo.id_titulo', '=', 'servicio_training_descripcion.id_titulo')->join('servicio_training', 'servicio_training_titulo.id_servicio', '=', 'servicio_training.id_servicio')->where('servicio_training.id_servicio', '=', 2)->get()->toArray();
    ...
    public function viewServicioFisio(){
        $rowData_ = DB::table('servicio_training')->get();
        $rowData_opciones = DB::table('servicio_training_titulo')->join('servicio_training_descripcion', 'servicio_training_titulo.id_titulo', '=', 'servicio_training_descripcion.id_titulo')->join('servicio_training', 'servicio_training_titulo.id_servicio', '=', 'servicio_training.id_servicio')->where('servicio_training.id_servicio', '=', 3)->get()->toArray();
    ...
    public function viewServicioFitness(){
        $rowData_ = DB::table('servicio_training')->get();
        $rowData_opciones = DB::table('servicio_training_titulo')->join('servicio_training_descripcion', 'servicio_training_titulo.id_titulo', '=', 'servicio_training_descripcion.id_titulo')->join('servicio_training', 'servicio_training_titulo.id_servicio', '=', 'servicio_training.id_servicio')->where('servicio_training.id_servicio', '=', 4)->get()->toArray();
