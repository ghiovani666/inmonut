...
class HomeController extends Controller
{
    ...
    public function viewServicioTenis(){
        ...
        $rowData_opciones = DB::table('servicio_training_titulo')->join('web_servicio_descripcion', 'servicio_training_titulo.id_titulo', '=', 'web_servicio_descripcion.id_titulo')->join('web_servicio', 'servicio_training_titulo.id_servicio', '=', 'web_servicio.id_servicio')->where('web_servicio.id_servicio', '=', 1)->get()->toArray();
    ...
    public function viewServicioPadel(){
        $rowData_ = DB::table('web_servicio')->get();
        $rowData_opciones = DB::table('servicio_training_titulo')->join('web_servicio_descripcion', 'servicio_training_titulo.id_titulo', '=', 'web_servicio_descripcion.id_titulo')->join('web_servicio', 'servicio_training_titulo.id_servicio', '=', 'web_servicio.id_servicio')->where('web_servicio.id_servicio', '=', 2)->get()->toArray();
    ...
    public function viewServicioFisio(){
        $rowData_ = DB::table('web_servicio')->get();
        $rowData_opciones = DB::table('servicio_training_titulo')->join('web_servicio_descripcion', 'servicio_training_titulo.id_titulo', '=', 'web_servicio_descripcion.id_titulo')->join('web_servicio', 'servicio_training_titulo.id_servicio', '=', 'web_servicio.id_servicio')->where('web_servicio.id_servicio', '=', 3)->get()->toArray();
    ...
    public function viewServicioFitness(){
        $rowData_ = DB::table('web_servicio')->get();
        $rowData_opciones = DB::table('servicio_training_titulo')->join('web_servicio_descripcion', 'servicio_training_titulo.id_titulo', '=', 'web_servicio_descripcion.id_titulo')->join('web_servicio', 'servicio_training_titulo.id_servicio', '=', 'web_servicio.id_servicio')->where('web_servicio.id_servicio', '=', 4)->get()->toArray();
