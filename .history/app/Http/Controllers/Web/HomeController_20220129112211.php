...
class HomeController extends Controller
{
    public function viewHome(){
        $slider_ = DB::table('web_home')->where('tipo', '=', 1)->get();
        $clases_ = DB::table('web_home')->where('tipo', '=', 2)->get();
        $fitness_ = DB::table('web_home')->where('tipo', '=', 3)->get();
        $entrenador_ = DB::table('web_home')->where('tipo', '=', 4)->get();
        $bienvenidos = DB::table('web_home')->get();
    	return view('web.layouts.pages.index')->with(compact('clases_'))->with(compact('slider_'))->with(compact('fitness_'))->with(compact('entrenador_'))->with(compact('bienvenidos'));
    }
