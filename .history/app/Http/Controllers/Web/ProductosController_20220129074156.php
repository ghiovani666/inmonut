    ...
    function load_data(Request $request){
      ...
      if(!$data->isEmpty()) {
        foreach($data as $row){
            ...
            <div  class="col-lg-3 col-lg-offset-0 col-md-3 col-md-offset-0 col-sm-4 col-sm-offset-0 col-xs-12 col-xs-offset-0 mix">
                <div class="wa-products">
                    ...
                    <div class="wa-products-caption">
                        <h2>
                            <a href="" style="font-weight: normal !important;">'.$row->pro_name.'</a>
                        </h2>
                    </div>
                </div>
            </div>
            ...
            $output .= '
            <div id="load_more">
                <button type="button" name="load_more_button" class="btn btn-success form-control" data-id="'.$last_id.'" id="load_more_button">Ver Más</button>
            </div>
            ';
      }else{
            $output .= '
            <div id="load_more">
                <button type="button" name="load_more_button" class="btn btn-info form-control">No se encontraron datos</button>
            </div>
            ';
        }
      echo $output;
