...
class ProductosController extends Controller
{
    ...
    */
                        ...
                        <div class="caption" style="cursor: pointer;"
                            ...
                            <div class="caption-text">
                                <ul class="wa-products-icon">
                                    ...
                                    <li><a href="" class="quickview-box-btn" title="Quick View"><i class="fa fa-eye"></i></a>
                                    </li>
    ...
    Public function Web\ProductosController($idDetalle) {
        ...
        ->where('products.id', $idDetalle)->get();
