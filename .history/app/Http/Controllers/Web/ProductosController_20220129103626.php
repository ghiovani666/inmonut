...
class ProductosController extends Controller
{
    ...
    */
            ...
            <div class="row" id="load_more">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        <li data-filter="*" class="filter-active"><button type="button" name="load_more_button" style="background-color: #000000;border-color: #000000;" class="btn btn-success form-control" data-id="'.$last_id.'" id="load_more_button">Ver Más</button></li>
                    </ul>
                </div>
            </div>       
            ';
    ...
    Public function productoGaleria() {
        return view('web.layouts.pages.productos.productoGaleria');
    }
