                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group editShowHide">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="txt_id_menu"></select>
                                            </div>
                                        </div>
    ...
    if (isValues == "ELIMINAR") {
        ...
        if (id_descripcion) {
            ...
            axios.post('editServicioTraining',
                ...
                $('select[name=txt_id_menu]').val(response.data[0].id_titulo);
...
const handleSecundario = (id_servicio) => {
    axios.post('changeServicioTraining', {
        ...
        .then(function (response) {
            $('select[name=txt_id_menu]').html(response.data);
