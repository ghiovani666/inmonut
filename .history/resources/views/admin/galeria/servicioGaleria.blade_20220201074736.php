    ...
    // CASO , SI ES FALSO => ES EDITAR
        if (id_gallery) {
            ...
            axios.post('editServicioGaleria',
                ...
                $('input[name=txt_id_servicio__]').val(response.data[0].id_gallery); //SIRVE PARA MANTENER LA TABLA EN EL FILTRO
                $('input[name=txt_titulo_principal__]').val(response.data[0].id_menu);
                $('input[name=txt_id_menu]').val(response.data[0].titulo);
