        ...
        <div class="container-fluid">
            ...
            <form id="clases_guardar_descripcion">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-block">
                            <h5 class="mb-2" style="text-align: center;">PRODUCTO ESPECIAL</h5>
                ...
                <div class="modal-footer">
                    <a href="/template_admin/img/modelo/producto_especial.jpg" class="btn btn-primary btn-sm" download><i
                            class="far fa-thumbs-up"></i>
                        Descargar Modelo Especial</a>
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-3">
                            <div class="card mb-2 bg-gradient-dark">
                                ...
                                <div class="card-img-overlay d-flex flex-column justify-content-end"
                                    ...
                                    <a href="javascript:void(0)" onclick="openModal({{ $rows->id_home }},'clases' )"
