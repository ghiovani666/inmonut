...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div id="msj_alert"></div>
            <!-- <form id="entrenador_guardar_descripcion">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-block">
                            <h5 class="mb-2" style="text-align: center;">Entrenadores Profesionales</h5>
                ...
                <div class="modal-footer">
                    <a href="/template_admin/img/modelo/model_entrenador.jpg" class="btn btn-primary btn-sm" download><i
            ...
            <a href="/template_admin/img/modelo/producto_top.jpg" class="btn btn-primary btn-sm" download><i
                            class="far fa-thumbs-up"></i>
                        Descargar Modelo Top</a>
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-3">
                            <div class="card mb-2 bg-gradient-dark">
                                ...
                                <div class="card-img-overlay d-flex flex-column justify-content-end"
                                    ...
                                    <a href="javascript:void(0)" onclick="openModal({{ $rows->id_home }},'entrenador' )"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="uploadForm">
                        ...
                        <input type="hidden" name="txt_values" value="entrenador" />
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-block">
