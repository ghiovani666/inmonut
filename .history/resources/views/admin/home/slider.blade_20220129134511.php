            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card card-widget">
                        ...
                        <div class="card-body" id="imagen_{{$slider_xx[1]->id_home}}">
                            <img class="img-fluid pad" src="{{$slider_xx[1]->url_image}}" alt="Photo"
                                style="max-width: 20% !important;">
                            <h6>{{$slider_xx[1]->title1}}</h6>
                            <h6>{{$slider_xx[1]->title2}}</h6>
                            <a href="/template_admin/img/modelo/modelo_slider_1.jpg" class="btn btn-primary btn-sm"
                                download><i class="far fa-thumbs-up"></i> Descargar Modelo Slider</a>
                            <a href="javascript:void(0)" onclick="openModal({{ $slider_xx[1]->id_home }},'slider' )"
                                class="btn btn-danger btn-sm"><i class="far fa-thumbs-up"></i> Subir Imagen</a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="user-block" style="margin-bottom: 25px;display: grid;margin-left: 40%;">
                                    ...
                                    <a href="/template_admin/img/modelo/modelo_logo.png" class="btn btn-primary btn-sm"
                                        download><i class="far fa-thumbs-up"></i>
                                        Descargar Modelo Logo</a><br />
                                </div>
                            </div>
