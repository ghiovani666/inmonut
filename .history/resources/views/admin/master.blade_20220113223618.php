...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    function openModalTraining(id_descripcion) {
        ...
        if (id_descripcion) {
            ...
            axios.post('editServicioTraining',
                ...
                $('input[name=txt_titulo_principal]').val((response.data[0].id_titulo);
                $('input[name=txt_sub_titulo]').val((response.data[0].title);
                $('input[name=txt_descripcion]').val((response.data[0].descripcion);
                $('input[name=txt_url_link]').val((response.data[0].url_link);

                // $('input[name=txt_sub_titulo]').val((response.data[0].url_image);
