...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    //     const images_ = this.value
    //     console.log(images_)
    //     $('img[name=txt_url_image]').attr('src', '../../'+images_);
    // })


    $("select[name=txt_titulo_principal]").change(function() {
    ...
    const handleSecundario = (id_servicio) => {
        axios.post('/change_imagen_select_color', {
            ...
            .then(function(response) {
                $('#txt_titulo_principal').html(response.data);
            }).catch(function(error) {
                if (error.response.status) {
