                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" name="superior_titulo1"
                                        class="form-control">{{$iclases_[3]->superior_titulo1  }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" name="superior_titulo2"
                                        class="form-control">{{$iclases_[3]->superior_titulo2  }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-3">
                            <div class="card mb-2 bg-gradient-dark">
                                ...
                                <div class="card-img-overlay d-flex flex-column justify-content-end"
                                    ...
                                    <a href="javascript:void(0)" onclick="openModal({{ $rows->id_servicio }},'fitness' )"
