    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form id="saveServiciosTraining">
                {{ csrf_field() }}
                <input type="hidden" name="txt_values" value="2" />
                <div class="row">
                    <div class="col-sm-12">
                ...
                <a href="/template_admin/img/modelo/modelo_servicio_1.png" class="btn btn-primary btn-sm" download><i
            ...
            <div class="card card-success">
                <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-3">
                            <div class="card mb-2 bg-gradient-dark">
                                ...
                                <div class="card-img-overlay d-flex flex-column justify-content-end"
                                    ...
                                    <a href="javascript:void(0)" onclick="openModal({{ $rows->id_servicio }},'padel' )"
                    ...
                    <a href="/template_admin/img/modelo/modelo_servicio_2.png" class="btn btn-primary btn-sm" download><i
                            class="far fa-thumbs-up"></i>
                        Descargar Modelo</a>
                </div>
                </div>
