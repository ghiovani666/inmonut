                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-3">
                            <div class="card mb-2 bg-gradient-dark">
                                ...
                                <div class="card-img-overlay d-flex flex-column justify-content-end"
                                    ...
                                    <a href="javascript:void(0)" onclick="openModalServicios({{ $rows->id_servicio }} ,'superior')"
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-3">
                            <div class="card mb-2 bg-gradient-dark">
                                ...
                                <div class="card-img-overlay d-flex flex-column justify-content-end"
                                    style="margin-bottom: 45px;">
                                    <a href="javascript:void(0)" onclick="openModalServicios({{ $rows->id_servicio }},'inferior' )"
                                        class="btn btn-danger btn-sm"><i class="far fa-thumbs-up"></i> Subir Imagen</a>
                                </div>
                            </div>
