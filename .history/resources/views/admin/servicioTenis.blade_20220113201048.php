                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0)"
                                                                        onclick="openModalTraining({{ $rows->id_descripcion }} ,{{ $rows->id_titulo }},{{ $rows->id_servicio }} )"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="uploadFormServicios">
                        ...
                        <input type="hidden" name="txt_id_servicio" />
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="txt_sub_titulo" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="txt_descripcion">Descripción</label>
                                            <textarea class="form-control"  name="txt_descripcion" rows="3" placeholder="Enter ..." required></textarea>
                                        </div>
                                        <div class="form-group">
