                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0)"
                                                                        onclick="openModalTraining({{ $rows->id_descripcion }},'ACTUALIZAR' )"
                                                                        class="btn btn-block bg-gradient-success"><i
                                                                            class="far fa-edit"></i> Editar</a>
                                                                    <a href="javascript:void(0)"
                                                                        onclick="openModalTraining({{ $rows->id_descripcion }},'ELIMINAR' )"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group" style="text-align: center">
                                            <div class="col-sm-12" style="margin-bottom: 20px">
                                                <img class="img-fluid" src="https://sistemas.com/wp-content/uploads/2013/12/twitpic.png" name="txt_url_image"
                                                    alt="Photo">
                                            </div>
