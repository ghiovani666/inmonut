                                        ...
                                        <div class="col-sm-12">
                                            <div class="card-block">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txt_footer_direccion"
                                                            class="form-control" value="{{$footer_[0]->direccion}}" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Teléfono</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txt_footer_telefono"
                                                            class="form-control" value="{{$footer_[0]->telefono}}" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txt_footer_boletin"
                                                            class="form-control" value="{{$footer_[0]->boletin}}" />
                                                    </div>
                                                </div>
                                                <!-- REDES SOSCIALES -->
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txt_footer_facebook"
                                                            class="form-control" value="{{$footer_[0]->red_social_facebook}}" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">URL ISTAGRAM</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txt_footer_instagram"
                                                            class="form-control" value="{{$footer_[0]->red_social_instagram}}" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">URL TWETTER</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="txt_footer_tweter"
                                                            class="form-control" value="{{$footer_[0]->red_social_tweter}}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                         ...
                         @foreach($slider_ as $rows)
                            <div class="col-md-12 col-lg-6 col-xl-3">
                                    <div class="card mb-2 bg-gradient-dark">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column justify-content-end" style="margin-bottom: 45px;">
                                            <a href="javascript:void(0)" onclick="openModal({{ $rows->id_home }},'slider' )" class="btn btn-danger btn-sm"><i class="far fa-thumbs-up"></i> Subir Imagen</a>
                                        </div>
                                    </div>
                                </div>
                        @endforeach
