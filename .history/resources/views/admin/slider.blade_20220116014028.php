            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card card-widget">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body" id="imagen_{{$slider_xx[0]->id_about}}">
                        ...
                        <div class="card-body">
                            ...
                            <a href="javascript:void(0)" onclick="openModal({{ $slider_xx[0]->id_about }},'slider' )"
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-3">
                            <div class="card mb-2 bg-gradient-dark">
                                ...
                                <div class="card-img-overlay d-flex flex-column justify-content-end"
                                    ...
                                    <a href="javascript:void(0)" onclick="openModal({{ $rows->id_about }},'slider' )"
                                        class="btn btn-danger btn-sm"><i class="far fa-thumbs-up"></i> Subir Imagen</a>
                                </div>
                            </div>
                        </div>
