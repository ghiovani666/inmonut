...
<section class="page_single">
        ...
        <div class="row contact-bottom padTB100">
            ...
            <div class="col-md-12">
                <div class="centered-title">
                    ...
                    <div class="clear"></div>
                    <p style="font-family: Lato, Sans-Serif;font-size: 1.89rem;">{{$rowData_[0]->inferior_descripcion}}</p>
                    <div class="clear"></div>
                </div>
            </div>
            <!--//==Section Heading End==//-->
    ...
    <div class="col-md-12 col-sm-12">
        <div class="row">
            <div class="map-area">
                <iframe src="{{ $rowData_[0]->inferior_url_image }}" width="600" height="450" style="border:0;" allowfullscreen=""
                    loading="lazy"></iframe>
            </div>
        </div>
    </div>
