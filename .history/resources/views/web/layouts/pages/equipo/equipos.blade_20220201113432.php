...
<!-- Titulo de la página -->
@section('title_page')
<title>Template en Desarrollo</title><title>Inmonut</title>@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-content content-style2">
                        <h2 class="title"><span>Equipos </h2>
                        <div class="desc">
                    ...
                    <div class="post-details-content">
                        <div class="post-details-body">
                            <div class="content">
                                ...
                                <h4 class="title">Nuestros Equipos
                                </h4>
                                ...
                                <div class="row row-gutter-28">
                                    <div class="col-md-6">
                                        <div class="thumb-inner mb-xxs-0">
                                            <img class="w-100" src="template_web/assets/img/blog/ds1.jpg" alt="Image" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="thumb-inner">
                                            <img class="w-100" src="template_web/assets/img/blog/ds2.jpg" alt="Image" />
                                        </div>
                                    </div>
                                </div>
