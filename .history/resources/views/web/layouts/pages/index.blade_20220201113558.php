...
<section class="wrapper">
    ...
    <!--//=======bIENVENIDOS=======//-->
       <div class="col-md-12">
        <div class="centered-title" style="margin-top: 45px;">
            <h1 style="text-transform: uppercase;">{{$bienvenidos[5]->title1}}</h1>
            <div class="clear"></div>
            <p style="font-family: Lato, Sans-Serif;font-size: 1.89rem;">{{$bienvenidos[5]->descripcion}}</p>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="centered-title">
                        ...
                        <div class="clear"></div>
                        <p style="font-family: Lato, Sans-Serif;font-size: 1.89rem;">Estos son nuestros productos
                            especiales que ofrecemos garantia y versatilidad. Somos
                ...
                <div
                    ...
                    <div class="wa-products">
                        ...
                        <div class="wa-products-thumbnail wa-item">
                            ...
                            <div class="caption" style="cursor: pointer;" onclick="window.location.href='#';">
                                <div class="caption-text">
    ...
    <section class="banners-section">
        <div class="container-fluid">
            <div class="row">
                @if(count($entrenador_)!=0)
                @foreach($entrenador_ as $img)
                <div class="col-md-6">
                    <div class="row">
                                    ...
                                    <div class="caption">
                                        <div class="caption-text">
                                            ...
                                            <div class="wa-banners-caption text-left">
                                                ...
                                                <h3>{{$img->title2}}</h3>
                                                <div class="clear"></div>
                                                <a href="/componets_web/2" class="theme-button marT10">Ver Detalles</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
