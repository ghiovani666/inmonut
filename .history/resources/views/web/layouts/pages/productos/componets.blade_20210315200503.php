            ...
            <div
                ...
                <div class="wa-products">
                    <div class="wa-products-thumbnail wa-item">
                        ...
                        <div class="caption" style="cursor: pointer;" onclick="window.location.href='/product_details_/{{$product->id}}';">
                    ...
                    <div class="wa-products-caption">
                        <h2>
                            <a
                                href="{{url('/product_details_')}}/{{$product->id}}" style="font-weight: normal !important;" >
                                <?php  echo 
                                $product->pro_name
                                //substr($product->pro_name, 0, 20).' ...';
                                 ?>
                                </a>
                        </h2>
                        <div class="clear"></div>
                        ...
                        <div class="clear"></div>
                        <span class="price">
                        <del>{{$product->price_old?'€'.$product->price_old:''}}</del>
