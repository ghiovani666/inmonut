                ...
                <div class="clearfix">
                    ...
                    <div class="carousel-column col-lg-6 col-md-6 col-sm-5 col-xs-12">
                        ...
                        <div id="wa-slide-image" class="owl-carousel  wa-slide-image carousel-style-1">
                            <?php $sizes = DB::table('imagen')->where('id_product',$Products[0]->id)->get();?>
                            @if(count($sizes)!=0)
                            @foreach ($sizes as $values)
                            <a href="{{ $values->url_image }}" class="fancybox" data-fancybox-group="group"
                                title="Chrome Finish faucet"> <img
                                    src="{{ $values->url_image }}" alt=""> </a>
                            @endforeach
                            </select>
                            @endif
                        ...
                        <div class="outer wow fadeInRight">
                            <div class="title-box">
                                <div class="inner marB30">
                                    <h2 class="marB10"  style="font-weight: normal !important;">{{ $Products[0]->pro_name }}</h2>
                                    <p class="availability in-stock">REF:
                                        <span>{{ $Products[0]->pro_code }}</span></p>
                                    <!-- <ul class="ratings">
                                        <li><a style="color: #ffc800 !important;" href="#"><i class="fa fa-star"></i></a></li>
                                        <li><a style="color: #ffc800 !important;" href="#"><i class="fa fa-star"></i></a></li>
                                        <li><a style="color: #ffc800 !important;" href="#"><i class="fa fa-star"></i></a></li>
                                        <li><a style="color: #ffc800 !important;" href="#"><i class="fa fa-star"></i></a></li>
                                        <li><a style="color: #ffc800 !important;" href="#"><i class="fa fa-star"></i></a></li>
                            ...
                            <div class="add-options">
                                <!-- <button type="button" class="theme-button">Ordenar Ahora</button>
