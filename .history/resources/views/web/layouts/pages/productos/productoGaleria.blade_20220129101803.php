        ...
        <section id="portfolio" class="portfoio">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row portfolio-container">
                    <?php 
                    try {
                        $Products = DB::table('web_producto_galeria')->get();
                    } catch (\Throwable $th) {
...
<script type="text/javascript" src="{{ URL::asset('template_inmonut/assets/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
