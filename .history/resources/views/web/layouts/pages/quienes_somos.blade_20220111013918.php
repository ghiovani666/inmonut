                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title text-center">
                                ...
                                <div class="desc">
                                    <p>Somos la mejor alternativa para que realices tu entrenamiento en amplios y
                                        confortables espacios. Anímate a elegir entre los diversos y estimulantes
                                        programas Fitness que tenemos, para que logres todo lo que te propones y por
                                        tanto puedas experimentar los beneficios de mantenerte bien a todo nivel.

                                        Estaremos contigo para apoyarte si es que asumes el reto de empezar con un
                                        estilo de vida activa y lleno de energía. No somos noveles en esto; tenemos
                                        experiencia y sobre todo mucha pasión por el Fitness.</p>
                                </div>
                            </div>
                        </div>
                    </div>
