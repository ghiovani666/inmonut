            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-content content-style2">
                        <h2 class="title"  style="color:{{$rowData_[0]->superior_titulo1_color}} !important;"><span>{{$rowData_[1]->superior_titulo1}}</span></h2>
                        <div class="desc">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-5">
                    <div class="divider-content">
                        <h2 class="title"  style="color:{{$rowData_[0]->superior_titulo1_color}} !important;">{{$rowData_[1]->inferior_titulo}}</h2>
