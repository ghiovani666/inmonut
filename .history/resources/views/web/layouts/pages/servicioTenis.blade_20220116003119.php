            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-content content-style2">
                        <h2 class="title" style="background-color: {{$rowData_[0]->superior_titulo1_color}} !important;"><span>{{$rowData_[0]->superior_titulo1}}</span></h2>
                        <div class="desc">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 to_animate animated fadeInUp">
                    <div class="teaser text-center">
                        <div class="teaser_icon main_bg_color size_normal round"  style="background-color: {{$rowData_[0]->superior_titulo1_color}} !important;">
