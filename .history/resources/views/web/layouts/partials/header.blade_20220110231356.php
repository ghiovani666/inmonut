                        ...
                        <div class="inner-container">
                            <div class="left-column">
                                <ul class="contact-info">
                                    <li><a href="mailto:needhelp@company.com"><i class="pe-7s-paper-plane"></i>72 Main
                                            Drive,
                                            Calibry, FL</a></li>
                                    <li><a href="tel:928886660000"><i
                                                class="pe-7s-mail-open"></i>learn.to.drive@drivega.com</a>
                                    </li>
