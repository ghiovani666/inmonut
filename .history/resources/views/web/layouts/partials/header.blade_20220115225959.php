                    ...
                    <div class="header-align">
                        ...
                        <div class="header-action-area">
                            <div class="header-action-cart d-none d-xl-block">
                                ...
                                <li class="has-submenu"><a href="#"><i class="fa fa-power-off" style="margin-right: 10px;"></i>Logout</a>
                                    <ul class="submenu-nav">
                                        <li><a href="viewEvento">Administrador</a></li>
                                        <li><a href="viewBono">Cerrar Sesión</a></li>
                                    </ul>
                                </li>
