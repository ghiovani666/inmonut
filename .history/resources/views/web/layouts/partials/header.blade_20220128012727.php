                     ...
                     <div class="col-md-8 supramenu-right">
                         <ul class="supramenu__list supramenu__list--right">
                             <li class="supramenu__item supramenu__item--icon">
                                 <a class="supramenu__link" href="https://es-es.facebook.com/azulejosrosapedidos/" target="">
                                     <i class="fa fa-facebook"></i>
                                 </a>
                             </li>
                             <li class="supramenu__item supramenu__item--icon">
                                 <a class="supramenu__link" href="https://www.instagram.com/azulejosrosamadrid/" target="">
     ...
     <div class="navbar navbar-default navbar-static-top" role="navigation">
         ...
         <div id="main-menu" class="wa-main-menu">
             <div class="wathemes-menu relative">
                 <div class="navbar navbar-default navbar-bg-light" role="navigation" style="background-color: #ffffff;">
                     <div class="container">
                         <div class="row">
                             <div class="col-md-12">
                                 <div class="navbar-header">
                                     ...
                                     <a  id="logo" class="navbar-brand hidden-lg hidden-md hidden-sm" href="/">
                                         <img class="site_logo" alt="Site Logo" src="{{ URL::asset('web/images/logos.png') }}" />
                                     </a>
                                 </div>
                                 <!-- Navbar Collapse -->
