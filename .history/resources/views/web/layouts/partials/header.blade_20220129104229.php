                             ...
                             <div class="col-md-12">
                                 ...
                                 <div class="navbar-collapse collapse">
                                     ...
                                     <ul class="nav navbar-nav" style="float: right;">
                                         <li>
                                             <a id="idDecoracion" style="background-color: #ffffff;color: #333;text-transform: uppercase;font-family: Lato, Sans-Serif;"
                                         ...
                                         <li>
                                             <a style="background-color: #ffffff;color: #333;text-transform: uppercase;font-family: Lato, Sans-Serif;"
                                                 href="/productoGaleria">Galería <span class="caret menu-arrow"></span><span
                                                     class="sub-arrow">...</span></a>
                                         </li>
                                         <li>
                                             <a style="background-color: #ffffff;color: #333;text-transform: uppercase;font-family: Lato, Sans-Serif;"
                                                 href="/contactaAhora">Contacto <span class="caret menu-arrow"></span><span
                                                     class="sub-arrow">...</span></a>
                                         </li>
