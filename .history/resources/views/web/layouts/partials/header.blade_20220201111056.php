     ...
     <div class="cssload-container">
         <div class="cssload-loading">
             <div id="object">
                 ...
                 <img src="/template_admin/img/1643477686_logo.png" alt="Evento" />
             </div>
         </div>
                     ...
                     <div class="col-md-8 supramenu-right">
                         <ul class="supramenu__list supramenu__list--right">
                             <li class="supramenu__item supramenu__item--icon">
                                 <a class="supramenu__link" href="{{ $footer_[0]->red_social_facebook }}" target="">
                                     <i class="fa fa-facebook"></i>
                                 </a>
                             </li>
                             <li class="supramenu__item supramenu__item--icon">
                                 <a class="supramenu__link" href="{{ $footer_[0]->red_social_instagram }}" target="">
                         ...
                         <div class="row">
                             <div class="col-md-12">
                                 <div class="navbar-header">
                                     ...
                                     <a href="/"><img src="{{ $footer_[0]->url_image }}" alt="Evento"
                                             style="width: 200px; margin-top: 9px;" /></a>
                                     <a id="logo" class="navbar-brand hidden-lg hidden-md hidden-sm" href="/">
                                         <img class="site_logo" alt="Site Logo" src="{{ $footer_[0]->url_image }}" />
                                     </a>
                                 </div>
                                 <!-- Navbar Collapse -->
                                     ...
                                     <ul class="nav navbar-nav" style="float: right;">
                                         <li>
                                             <a style="background-color: #ffffff;color: #333;text-transform: uppercase;font-family: Lato, Sans-Serif;"
                                                 href="/galeriaPrincipal/4">Decoración <span class="caret menu-arrow"></span><span
                                                     class="sub-arrow">...</span></a>
                                         </li>
                                         <li>
                                             <a style="background-color: #ffffff;color: #333;text-transform: uppercase;font-family: Lato, Sans-Serif;"
                                                 href="/galeriaPrincipal/3">Reformas <span class="caret menu-arrow"></span><span
                                                     class="sub-arrow">...</span></a>
                                         </li>
                                         <li>
                                             <a style="background-color: #ffffff;color: #333;text-transform: uppercase;font-family: Lato, Sans-Serif;"
                                                 href="/galeriaPrincipal/2">Proyectos <span class="caret menu-arrow"></span><span
                                                     class="sub-arrow">...</span></a>
                                         </li>
                                         <li>
                                             <a style="background-color: #ffffff;color: #333;text-transform: uppercase;font-family: Lato, Sans-Serif;"
                                                 href="/galeriaPrincipal/1">Galería <span
