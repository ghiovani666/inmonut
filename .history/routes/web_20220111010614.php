...
Route::get('/viewServices2', 'Web\HomeController@viewServices1')->name('viewServices2');
Route::get('/viewServices3', 'Web\HomeController@viewServices1')->name('viewServices3');
Route::get('/viewServices4', 'Web\HomeController@viewServices1')->name('viewServices4');
Route::get('/viewServices5', 'Web\HomeController@viewServices1')->name('viewServices5');
Route::get('/viewServices6', 'Web\HomeController@viewServices1')->name('viewServices6');
