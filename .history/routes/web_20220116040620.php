...
*/
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        Route::post('/changeServicioTraining',            'Admin\HomeController@changeServicioTraining');
        Route::post('/saveServiciosTraining',             'Admin\HomeController@saveServiciosTraining');
        Route::post('/imagenServiciosTraining',           'Admin\HomeController@imagenServiciosTraining');
