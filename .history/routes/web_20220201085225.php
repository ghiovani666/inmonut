...
*/
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
        ...
        //::::::::::::::::::::::: CONTROLLER GALERIAS: CRUD DE GALERIAS :::::::::::::::::::::::::: 1/02/2022
        Route::get('/galeriaPrincipal',         'Admin\GaleriaController@galeriaPrincipal');
        Route::get('/listarGaleriaDataTable',   'Admin\GaleriaController@listarGaleriaDataTable');
        Route::post('/createServicioGaleria',   'Admin\GaleriaController@createServicioGaleria');
        Route::post('/editServicioGaleria',     'Admin\GaleriaController@editServicioGaleria');

    });


    //::::::::::::::::::::::: CONTROLLER PRODUCTOS ::::::::::::::::::::::::::
    Route::get('/productCategory/{idCat}',  'Web\ProductosController@productCategory')->name('productCategory');
    Route::post('/productCategoryLoad', 'Web\ProductosController@productCategoryLoad')->name('productCategoryLoad');
    Route::get('/productDetail/{idDetalle}', 'Web\ProductosController@productDetail')->name('productDetail');
    Route::get('/productoGaleria', 'Web\ProductosController@productoGaleria')->name('productoGaleria');
    Route::post('/productoGaleriaLoad', 'Web\ProductosController@productoGaleriaLoad')->name('productoGaleriaLoad');
    //::::::::::::::::::::::: CONTROLLER QUIENES SOMOS ::::::::::::::::::::::::::
    Route::get('/quienesSomos', 'Web\AboutController@quienesSomos')->name('quienesSomos');
    Route::get('/contactaAhora', 'Web\ContactoController@contactaAhora')->name('contactaAhora');


    //::::::::::::::::::::::: CONTROLLER GALERIAS ::::::::::::::::::::::::::  1/02/2022
    Route::get('/galeriaPrincipal',  'Web\GaleriaController@galeriaPrincipal')->name('galeriaPrincipal');
    Route::post('/galeriaGaleriaLoad', 'Web\ProductosController@galeriaGaleriaLoad')->name('galeriaGaleriaLoad');
